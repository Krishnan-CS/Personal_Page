...
export default function Contact() {
  const { name, email, linkedin, github, location } = profile.personal;
      ...
      <div className="max-w-2xl mx-auto text-center space-y-8">
        <div>
          ...
          <p className="text-slate-400">
            Based in {location} · Open to relocation · Let&apos;s connect.
          </p>
        </div>
        ...
        <div className="flex flex-col sm:flex-row justify-center gap-4">
          {links.map(({ label, href, description, icon }) => (
            <a
              ...
              className="flex items-center gap-3 px-5 py-4 rounded-xl bg-slate-800 border border-slate-700 hover:border-indigo-500 hover:bg-slate-700 transition-colors group"
            >
